      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Effects', slug: 'docs/reference/effects' },
            { label: 'Contracts', slug: 'docs/reference/contracts' },
            { label: 'Tests', slug: 'docs/reference/tests' },
            { label: 'Tool Policies', slug: 'docs/reference/tools' },
